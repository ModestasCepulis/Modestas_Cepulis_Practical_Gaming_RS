...
public class P2WagonController : MonoBehaviour
{
    ...
    {
        randomTomatoes = UnityEngine.Random.Range(1, 15);

        randomCarrots = UnityEngine.Random.Range(1, 15);
